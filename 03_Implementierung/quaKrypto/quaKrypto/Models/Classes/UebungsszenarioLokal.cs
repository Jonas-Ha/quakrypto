            ...
            switch (Variante)
            {
                ...
                case VarianteAbhoeren:
                    ...
                    else if (startPhase == 4)
                    {
                        ...
                        if (schwierigkeit > 1) rolleBob.SpeicherInformationAb(VApolschataAlice, true);
                        if (schwierigkeit > 1) rolleBob.SpeicherInformationAb(VApolschataDifferenzBob, true);
                        if (schwierigkeit > 1) rolleBob.SpeicherInformationAb(VAschlüsselbits2Bob, true);
                        if (schwierigkeit > 1) rolleEve.SpeicherInformationAb(VApolschataDifferenzBob, true);
                        if (schwierigkeit > 1) rolleEve.SpeicherInformationAb(VAschlüsselbits2Eve, true);
                        ...
                        //---------//
                        if (schwierigkeit > 1) rolleAlice.SpeicherInformationAb(VAprüfbitAnzahl, true);
                        ...
                        if (schwierigkeit > 1) rolleAlice.SpeicherInformationAb(VAprüfbitsAlice, true);
                        ...
                        if (schwierigkeit > 1) rolleEve.SpeicherInformationAb(VAprüfbitsEve, true);
                        ...
                        if (schwierigkeit > 1) rolleBob.SpeicherInformationAb(VAprüfbitsBob, true);
                        rolleBob.SpeicherInformationAb(VAschlüsselbits3Bob, true);
                        if (schwierigkeit > 1) rolleEve.SpeicherInformationAb(VAprüfbitsBob, true);
                        rolleEve.SpeicherInformationAb(VAprüfbitsDifferenzEve, true);
                        if (schwierigkeit > 1) rolleAlice.SpeicherInformationAb(VAprüfbitsBob, true);
